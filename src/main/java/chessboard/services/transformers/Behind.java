...
/**
 * Methods for finding a square behind a given square.
 *
 * @author David Hatton
 */
public abstract class Behind extends Transformer {

	public static int behind(Square origin, int distance) throws NoPieceException, OutOfBoundsException {
		int destination = -1;
		Color color;
